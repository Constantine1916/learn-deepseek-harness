...
Phase 0 supports exactly DeepSeek Harness `0.1.0-rc.5` on Node.js `^22.19.0 || >=24.0.0`. The machine-readable authority is [`compatibility.json`](../compatibility.json).
