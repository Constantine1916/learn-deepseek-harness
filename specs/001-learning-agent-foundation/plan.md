...
- P5-01（待授权）：发布 @learn-dsh/bundle 及其依赖包。关联 F-001。DSH `0.1.2-rc.1` 已发布完整运行时包集，registry-only 本地门禁和远程 matrix 均已通过；真实 publish 仍需人工验收并获得明确发布授权。
...
- P5-07（完成）：已迁移到 DSH `0.1.2-rc.1`，重验公开扩展点、12 个课程来源锚点、Session 恢复与 Learner Event Store 连续性，并移除运行时本地 `link:` 依赖；registry-only 发布候选已通过 Ubuntu 24.04 Node 22.19/24 和 macOS Node 22.19 远程 matrix。关联 F-001、F-006、F-011、F-012、Q-005、Q-006。
