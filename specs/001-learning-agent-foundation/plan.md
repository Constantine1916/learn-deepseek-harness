...
- P3-01：实现目标收集和诊断活动。关联 F-004。
- P3-02：从课程 objectives/rubric 动态构造诊断候选，不播放固定题单。关联 F-004。
- P3-03：实现先修过滤、误区优先和目标路径选择。关联 F-005。
- P3-04：实现计划展示、调整和原因记录。关联 F-005。
- P3-05：增加初学者和有经验开发者两条 keyless 场景。关联 Q-004、Q-006。
