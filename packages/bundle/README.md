...
The supported DSH runtime is installed from the npm registry at the exact version documented in the repository's [compatibility guide](https://github.com/Constantine1916/learn-deepseek-harness/blob/main/docs/compatibility.md). The separate locked DSH source checkout is used only for curriculum anchors. The patch assumes its host profile already provides the DSH Agent/System Prompt/Tools and sandboxed FS/Shell capability stack.
